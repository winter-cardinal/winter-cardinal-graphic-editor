...
(function (wcardinalUi, pixi_js) {
    ...
    class ESubthemeDefaultJaJpEditorShapeButton extends ESubthemeDefaultEditorShapeButton {
    ...
    class EThemeDefaultJaJpShapeButton {
        getName() {
            return "ボタン";
        }
        getLabel() {
    ...
    class ESubthemeDefaultJaJpEditorShapeButtonLayer extends ESubthemeDefaultEditorShapeButtonLayer {
        getButtonNewTitle() {
            return "列の新規作成";
        }
    ...
    class EThemeDefaultJaJpDialogShapeButtonLayerValue extends EThemeDefaultDialogShapeButtonLayerValue {
        getInputLabelLabel() {
            return "ラベル";
        }
        newInputLabel() {
    ...
    class EThemeDefaultJaJpShapeButtonLayer {
        getName() {
            return "レイヤーボタン";
        }
        getLabel() {
    ...
    class ESubthemeDefaultJaJpEditorShapeChartLine extends ESubthemeDefaultEditorShapeChartLine {
        getCheckXAxisLabel() {
            return "X軸";
        }
    ...
    class EThemeDefaultJaJpShapeChartLine {
        getName() {
            return "ラインチャート";
        }
        newPlotAreaLabel() {
    ...
    class ESubthemeDefaultJaJpEditorShapeEmbeddedAcceptorEdge extends ESubthemeDefaultEditorShapeEmbeddedAcceptorEdge {
    ...
    class EThemeDefaultJaJpShapeEmbeddedAcceptorEdge {
        getName() {
            return "接続点";
        }
    }

    class EThemeDefaultJaJpShapeInput {
        getName() {
            return "インプット";
        }
        getLabel() {
    ...
    class ESubthemeDefaultJaJpEditorShapeTable extends ESubthemeDefaultEditorShapeTable {
        getButtonNewTitle() {
            return "新規列の作成";
        }
        getButtonDeleteTitle() {
    ...
    class EThemeDefaultJaJpDialogShapeTableColumn extends EThemeDefaultDialogShapeTableColumn {
    ...
    class EThemeDefaultJaJpShapeTable {
        getName() {
            return "テーブル";
        }
        getHeaderName() {
    ...
    class EThemeDefaultJaJpButtonLock extends EThemeDefaultButtonLock {
        getTitle() {
            return "ロック";
        }
    }

    class EThemeDefaultJaJpDialogAction extends EThemeDefaultDialogAction {
    ...
    class EThemeDefaultJaJpDialogCanvas extends EThemeDefaultDialogCanvas {
    }

    class EThemeDefaultJaJpDialogDataMappingValue extends EThemeDefaultDialogDataMappingValue {
        getInputSourceLabel() {
            return "変換対象";
        }
    ...
    class EThemeDefaultJaJpDialogDataValue extends EThemeDefaultDialogDataValue {
        getInputIdLabel() {
            return "ID";
        }
        getInputAsLabel() {
    ...
    class EThemeDefaultJaJpDialogLayer extends EThemeDefaultDialogLayer {
        getInputNameLabel() {
            return "名前";
        }
    ...
    class EThemeDefaultJaJpDialogSnap extends EThemeDefaultDialogSnap {
    ...
    class EThemeDefaultJaJpEditorAction extends EThemeDefaultEditorAction {
        getLabel() {
            return "アクション";
        }
        getButtonNewTitle() {
    ...
    class EThemeDefaultJaJpEditorCanvasLegacy extends EThemeDefaultEditorCanvasLegacy {
    }

    class EThemeDefaultJaJpEditorCanvas extends EThemeDefaultEditorCanvas {
        getLabel() {
            return "キャンバス";
        }
        getDefaultName() {
    ...
    class EThemeDefaultJaJpEditorCoordinate extends EThemeDefaultEditorCoordinate {
        getLabel() {
            return "位置とサイズ";
        }
        getInputIdLabel() {
    ...
    class EThemeDefaultJaJpEditorDataMapping extends EThemeDefaultEditorDataMapping {
        getLabel() {
            return "データ変換";
        }
        getButtonNewTitle() {
    ...
    class EThemeDefaultJaJpEditorData extends EThemeDefaultEditorData {
        getLabel() {
            return "データ";
        }
        getButtonNewTitle() {
    ...
    class EThemeDefaultJaJpEditorLayer extends EThemeDefaultEditorLayer {
        getLabel() {
            return "レイヤー";
        }
        getButtonNewTitle() {
    ...
    class EThemeDefaultJaJpEditorSearch extends EThemeDefaultEditorSearch {
        getLabel() {
            return "検索";
        }
        getInputIdLabel() {
    ...
    class EThemeDefaultJaJpEditorShape extends EThemeDefaultEditorShape {
        getLabel() {
            return "シェイプ";
        }
    ...
    class EThemeDefaultJaJpEditorSnap extends EThemeDefaultEditorSnap {
        getLabel() {
            return "スナップ";
        }
    ...
    class EThemeDefaultJaJpEditorText extends EThemeDefaultEditorText {
        getLabel() {
            return "テキスト";
        }
        getTextFontLabel() {
    ...
    class EThemeDefaultJaJpEditorTree extends EThemeDefaultEditorTree {
        getLabel() {
            return "ツリー";
        }
    ...
    class EThemeDefaultJaJpEditorValidation extends EThemeDefaultEditorValidation {
        getLabel() {
            return "検証";
        }
    ...
    class EThemeDefaultJaJpShapeActionValue extends EThemeDefaultShapeActionValue {
        toTypeLabel(type) {
            switch (type) {
                case wcardinalUi.EShapeActionValueType.SHOW_HIDE:
                    return "表示切替";
    ...
    class FThemeDefaultJaJpGraphicEditor extends FThemeDefaultGraphicEditor {
    ...
    class FThemeDefaultJaJpGraphicTester extends FThemeDefaultGraphicTester {
    ...
    class FThemeDefaultJaJpGraphicViewer extends FThemeDefaultGraphicViewer {
    }

    class FThemeDefaultShapeType {
    }

    class FThemeDefaultJaJpShapeType extends FThemeDefaultShapeType {
        getLabel(shapeType) {
            switch (shapeType) {
