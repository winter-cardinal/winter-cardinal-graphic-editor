...
(function (wcardinalUi, pixi_js) {
    ...
    ***************************************************************************** */
    ...
    var EThemeDefaultEnUsEditorShape = /** @class */ (function (_super) {
        ...
        EThemeDefaultEnUsEditorShape.prototype.getButtonFillColorTitle = function () {
            return "Fill Color";
        };
        EThemeDefaultEnUsEditorShape.prototype.getInputFillPercentTitle = function () {
            return "Fill Percent";
        };
        EThemeDefaultEnUsEditorShape.prototype.getButtonFillDirectionTopTitle = function () {
            return "Fill Top to Bottom";
        };
        EThemeDefaultEnUsEditorShape.prototype.getButtonFillDirectionRightTitle = function () {
            return "Fill Right to Left";
        };
        EThemeDefaultEnUsEditorShape.prototype.getButtonFillDirectionBottomTitle = function () {
            return "Fill Bottom to Top";
        };
        EThemeDefaultEnUsEditorShape.prototype.getButtonFillDirectionLeftTitle = function () {
